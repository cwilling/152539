...
%  [net_COBN,INPUT2E,INPUT2I,SEED_connections,SEED_poisson,tLastSP,V] = initialise_inputs();
%function [net_COBN,INPUT2E,INPUT2I,SEED_connections,SEED_poisson,tLastSP,V] = initialise_inputs ()
...
return
  ...
  ax2 = nexttile; plot(tLastSP(1:last_spike), 'Color', 'blue'); title('tLastSP');            xlabel('time');
  linkaxes([ax1 ax2],'x');
